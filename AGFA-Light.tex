...
% !TEX tabbedFile{./content/AGFA-Section-1-Light.tex}(Abschnitt 1)
% !TEX tabbedFile{./content/AGFA-Section-2-Light.tex}(Abschnitt 2)
%% -------------------------- 
%% --  AGFA-Light
%% -- Stand:	2023/02/13   
%% -------------------------- 
...
\input{./content/AGFA-Section-2-Light% !TEX useTabsWithFiles
% !TEX useTabsWithFiles
}
